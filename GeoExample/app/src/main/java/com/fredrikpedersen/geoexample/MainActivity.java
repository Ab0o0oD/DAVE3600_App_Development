package com.fredrikpedersen.geoexample;
...
public class MainActivity extends AppCompatActivity {
    ...
    private class GetLocationTask extends AsyncTask<Void, Void, String> {
        ...
        protected String doInBackground(Void... params) {
            String s = "";
            String output = "";
            String query = "https://maps.googleapis.com/maps/api/geocode/json? address="+ address.replaceAll(" ", "%20") + "&key=DIN_NØKKEL";
